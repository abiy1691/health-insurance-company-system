...
<head>
    ...
    <title>My Policies | Health Insurance</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">My Active Policies</h1>
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="detail_owned.php?policy_id=<?php echo $policy['policy_id']; ?>" 
                ...
                <div class="no-policies">
                    ...
                    <p class="text-muted">You don't have any active policies at the moment. Please contact your agent for assistance.</p>
                    <a href="policy_plan.php" class="btn btn-primary mt-3">
                        <i class="fas fa-file-contract"></i> View Available Plans
                    </a>
                </div>
                <?php endif; ?>
